...
using CheWei_WAD_Task_S2.Data;
using CheWei_WAD_Task_S2.Models;

namespace CheWei_WAD_Task_S2.Controllers
{
    public class EnrollmentsController : Controller
    {
        private readonly CheWei_WAD_Task_S2Context _context;

        public EnrollmentsController(CheWei_WAD_Task_S2Context context)
        {
            _context = context;
        }
        ...
        {
            var cheWei_WAD_Task_S2Context = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
            return View(await cheWei_WAD_Task_S2Context.ToListAsync());
        }
